...
const CustomDrawer = (props) => {
  ...
  return (
    <DrawerContentScrollView {...props} style={{backgroundColor:'black'}} >
      ...
      <View style={{borderTopWidth: 1,borderTopColor:'#919191', borderBottomWidth: 1, borderBottomColor: '#919191', paddingVertical: 10, }}>
          <Pressable onPress={handleLogout} style={{ backgroundColor: '#EF5350', paddingVertical: 10, marginTop:390, }}>
